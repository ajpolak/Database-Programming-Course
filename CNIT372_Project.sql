...
-- 8
/*
How would you insert, update or delete an author and book from the database tables? 
*/
...
/
delete from branch where branchid = 'BR1';
/
...
/
insert into book values('1016', 'C002', 'The Book',	'J. D.', 'Salinger', '15-NOV-90', 'InStock', 12.99);
/
...
begin
dbms_output.put_line('The availability date of the book that is rented out: ');
